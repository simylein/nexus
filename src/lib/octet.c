...
uint64_t octet_uint64_read(uint8_t *row, uint16_t row_ind) {
...
int8_t octet_int8_read(uint8_t *row, uint16_t row_ind) {
	int8_t value = (int8_t)row[row_ind];
	return value;
}

int16_t octet_int16_read(uint8_t *row, uint16_t row_ind) {
	int16_t value = (int16_t)(((uint16_t)(row[row_ind]) << 8) | (uint16_t)row[row_ind + 1]);
	return value;
}

int32_t octet_int32_read(uint8_t *row, uint16_t row_ind) {
	int32_t value = (int32_t)(((uint32_t)(row[row_ind]) << 24) | ((uint32_t)(row[row_ind + 1]) << 16) |
														((uint32_t)(row[row_ind + 2]) << 8) | (uint32_t)row[row_ind + 3]);
	return value;
}

int64_t octet_int64_read(uint8_t *row, uint16_t row_ind) {
	int64_t value =
...
void octet_bool_write(uint8_t *row, uint16_t row_ind, bool value) { row[row_ind] = value; }

void octet_uint8_write(uint8_t *row, uint16_t row_ind, uint8_t value) { row[row_ind] = value; }
...
void octet_uint32_write(uint8_t *row, uint16_t row_ind, uint32_t value) {
...
void octet_uint64_write(uint8_t *row, uint16_t row_ind, uint64_t value) {
...
void octet_int8_write(uint8_t *row, uint16_t row_ind, int8_t value) { row[row_ind] = (uint8_t)value; }

void octet_int16_write(uint8_t *row, uint16_t row_ind, int16_t value) {
	row[row_ind] = (uint8_t)(value >> 8);
	row[row_ind + 1] = (uint8_t)(value & 0xff);
}

void octet_int32_write(uint8_t *row, uint16_t row_ind, int32_t value) {
	row[row_ind] = (uint8_t)(value >> 24);
	row[row_ind + 1] = (uint8_t)(value >> 16);
	row[row_ind + 2] = (uint8_t)(value >> 8);
	row[row_ind + 3] = (uint8_t)(value & 0xff);
...
void octet_int64_write(uint8_t *row, uint16_t row_ind, int64_t value) {
	row[row_ind] = (uint8_t)(value >> 56);
	row[row_ind + 1] = (uint8_t)(value >> 48);
	row[row_ind + 2] = (uint8_t)(value >> 40);
	row[row_ind + 3] = (uint8_t)(value >> 32);
...
void octet_blob_write(uint8_t *row, uint16_t row_ind, uint8_t *value, uint16_t value_len) {
	memcpy(&row[row_ind], value, value_len);
}

void octet_text_write(uint8_t *row, uint16_t row_ind, char *value, uint16_t value_len) {
	memcpy(&row[row_ind], value, value_len);
}
